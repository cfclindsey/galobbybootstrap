...
if ( current_path() == $element['#href']) {
  ...
  if ($element['#below']) {
    ...
    $menu_title_html = '<i class="fa '. $menu_extra_class .' "></i><span>' . $element['#title'] . '</span><span class="pull-right-container "><i class="fa fa-angle-right pull-right"></i></span>';
      ...
      $menu_link = "/".$element['#href'];
            ...
            if ($element['#href'] == "admin") {
                $output = "";
                  ...
                  $output = l($menu_title_html, $menu_link,   array('html' => TRUE));
            }
...
function admintheme_pager($variables) {
  ...
  function admintheme_page_alter(&$page) {
  unset($page['page_top']['toolbar']);
  unset($page['content']['search_form']);
